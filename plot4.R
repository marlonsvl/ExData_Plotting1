...
plot4 <- function(){
  par(mfrow=c(2,2))
  # plot 1
  plot(datosReq$timestamp, datosReq$Global_active_power, type="l", xlab = "", ylab = "Global Active Power")
  # plot 2
  plot(datosReq$timestamp, datosReq$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
  #plot 3
  ...
  #plot 4
  plot(datosReq$timestamp,datosReq$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
  
  #OUTPUT
  dev.copy(png, file="plot4.png", width=480, height=480)
  dev.off()
  cat("plot4.png generado", getwd())
